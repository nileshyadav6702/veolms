...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md space-y-6">
      ...
      {/* Render Free Tier Warning in red text (from DESIGN.md) */}
      <div className="p-3.5 rounded-lg bg-red-50 border border-red-100 flex items-start gap-2.5 text-xs text-red-600">
        <AlertCircle className="w-4 h-4 shrink-0 mt-0.5 text-red-500" />
        <span className="font-semibold text-red-600 leading-normal">
          Notice: This application is deployed on Render's free tier. The first backend request can take up to 50 seconds as the server spins up from standby.
        </span>
      </div>
